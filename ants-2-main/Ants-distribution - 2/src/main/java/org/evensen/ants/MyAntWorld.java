 ...
 */
    ...
    public MyAntWorld(int width, int height, int food, DispersalPolicy dp){
        this.width = width;
        this.height = height;
    ...
    public void dispersePheromones(){
        for(int x = 0; x != foodPheromones.length; x++){
            for(int y = 0; y < foodPheromones[x].length; y++){
                foodPheromones[x][y] = dispersalPolicy.getDispersedValue(this, new Position(x,y))[1];
            }
        }
        for(int x = 0; x != foragingPheromones.length; x++){
            for(int y = 0; y < foragingPheromones[x].length; y++){
                foragingPheromones[x][y] = dispersalPolicy.getDispersedValue(this, new Position(x,y))[0];
            }
        }
    ...
    //@Override
    public void oldDispersePheromones() {
